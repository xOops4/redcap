...
class Condition extends AbstractResource
{
  ...
  public function getNormalizedClinicalStatus() {
    return $this->getClinicalStatus() ?: ($this->getClinicalStatusCode() ?: '');
  }

  /**
   * Returns an array mapping property keys to extractor callables.
   * Each callable accepts a Condition resource as parameter.
   *
   * @return array
   */
  public static function getPropertyExtractors(): array
  {
    return [
      ...
      'clinical_status'       => fn(self $resource) => $resource->getNormalizedClinicalStatus(),
