...
{
    public static class ExportSurveyReturnCode
    {
        public static async Task<RestResponse> ExportSurveyReturnCodeAsync()
        {
            try
            {
                // Setup
                ...
                request.AddParameter("content", "surveyReturnCode");
