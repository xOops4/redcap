...
/*
 CVS:
  $Id: WebdavClient.php,v 1.7 2004/08/18 14:12:40 chris Exp $
  $Author: chris $
  $Date: 2004/08/18 14:12:40 $
  $Revision: 1.7 $
*/
/**
 * WebdavClient v0.1.3, a php based webdav client class.
 *
...
class WebdavClient {
	...
	var $_errno;
	var $_errstr;
	var $_user_agent = 'php class WebdavClient $Revision: 1.7 $';
	var $_crlf = "\r\n";
	var $_req;
	var $_resp_status;
	var $_parser;
 ...
 /**
	...
	*/
	function set_ssl($ssl) {
		if ((isset($ssl) && $ssl == '1') || $this->_port == '443') {
			$this->_ssl = 'ssl://';
		} else {
			$this->_ssl = '';
		}
 ...
 /**
	...
	*/
	function open() {
		...
		$this->_fp = fsockopen ($this->_ssl . $this->_server, (isinteger($this->_port) ? $this->_port : 80), $this->_errno, $this->_errstr, $this->_socket_timeout);
		// stop if the socket connection fails
